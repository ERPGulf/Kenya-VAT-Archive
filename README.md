## Kenya VAT management and reporting - ERPNext module.

This is minor tweak of E-invoing done on ( https://github.com/ahmadpak/ksa_vat ) for Kenya. Full credit goes to Havenir Solutions who has done most of the coding. 
...
How to install
--------------
bench get-app kenya_vat https://github.com/ERPGulf/Kenya-VAT.git

bench --site site1.local install-app kenya_vat
...
Functional documentation ( We have published a video documentation on Kenya VAT on our youtube channel , please watch https://youtu.be/G3vo3oUaD2s ) 
-------------------------
...
Find the new Kenya VAT report and Kenya VAT settings document in the Accounting Workspace

Kenya VAT Setting is mapping item Tax Template and Account to the respective title to be shown in the report
...
Use the Item Tax Template in the Sales and Purchase Invoice. The data should result in a similar Kenya VAT Report
