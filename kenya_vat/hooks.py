...
app_description = "Kenya VAT Management and Reporting"
...
doc_events = {
    "Company": {
        "on_update": "kenya_vat.kenya_vat.setup.operations.setup_kenya_vat_setting.create_kenya_vat_setting",
        "on_update": "kenya_vat.kenya_vat.setup.operations.setup_kenya_vat_setting.make_custom_fields"
    },
    "Sales Invoice": {
        "after_insert": "kenya_vat.events.accounts.sales_invoice.create_qr_code",
        "on_trash": "kenya_vat.events.accounts.sales_invoice.delete_qr_code_file"
    }
}
...
jenv = {
    'methods': [
        'string_to_json:kenya_vat.jinja.utils.string_to_json'
    ]
}
